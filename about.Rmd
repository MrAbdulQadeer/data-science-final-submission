...
#### Documentation:
1. Presentation slide deck: Available on the [RPubs page](http://rpubs.com/Qadeer/655751)
2. Source code for ui.R and server.R files: Available on the [GitHub repo](https://github.com/abdulqadeer1029/data-science-final-submission)
3. About, ReadMe, PNG and JPG files: Available on the [GitHub repo](https://github.com/abdulqadeer1029/data-science-final-submission)
4. Cleansed data: Available on the [GitHub repo](https://github.com/abdulqadeer1029/data-science-final-submission)

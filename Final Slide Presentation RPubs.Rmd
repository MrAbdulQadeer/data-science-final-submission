...
Try it now...select it [here](https://abdulqadeer.shinyapps.io/Data-Science-Capstone-Project/)
...
- Code is available on [GitHub](https://github.com/abdulqadeer1029/data-science-final-submission.git)
